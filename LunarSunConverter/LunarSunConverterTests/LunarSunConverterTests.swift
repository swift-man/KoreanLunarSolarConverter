...
class LunarSunConverterTests: XCTestCase {
  ...
  func testConvertSunToLunar() throws {
    ...
    print(c2.lunarZodiac)

    let c3 = KoreanLunarConverter()
    c3.lunarDate(lunarYear: 1914, lunarMonth: 6, lunarDay: 24, isIntercalation: false)

    print(c3.solarIsoFormat)
    print(c3.lunarZodiac)

    let c4 = KoreanLunarConverter()
    c4.lunarDate(lunarYear: 2017, lunarMonth: 6, lunarDay: 29, isIntercalation: false)

    print(c4.solarIsoFormat)
    print(c4.lunarZodiac)

    let c5 = KoreanLunarConverter()
    c5.solarDate(solarYear: 2017, solarMonth: 6, solarDay: 29)

    print(c5.lunarIsoFormat)
    print(c5.lunarZodiac)
